...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `Você é um mecânico virtual experiente e prestativo. Seu papel é ajudar mecânicos com dúvidas técnicas do dia a dia.

Regras importantes:
- Dê respostas CURTAS e DIRETAS (máximo 2-3 parágrafos)
